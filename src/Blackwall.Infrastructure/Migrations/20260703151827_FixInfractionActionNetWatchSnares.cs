...
{
    /// <inheritdoc />
    public partial class FixInfractionActionNetWatchSnares : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NetWatchSnareChannels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NetWatchSnareChannels_SpamConfigurations_SpamConfigurationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NetWatchSnareChannels_SpamConfigurationId_DiscordChannelId",
