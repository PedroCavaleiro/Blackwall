    ...
    public async Task OnJoinedGuildAsync(SocketGuild guild) {
        ...
        var guildInstance = new GuildInstance {
            ...
            SpamConfiguration = new SpamConfiguration {
                ...
                IsLockedDown = false,
                RateLimitAction = InfractionAction.Timeout,
                RateLimitAutoLockdown = false,
                RateLimitTimeoutMinutes = 10,
                RateLimitMessageDeleteDays = 0,
                DuplicateAction = InfractionAction.Timeout,
                DuplicateAutoLockdown = false,
                DuplicateTimeoutMinutes = 10,
                DuplicateMessageDeleteDays = 0,
                MentionLimitAction = InfractionAction.Timeout,
                MentionLimitAutoLockdown = false,
                MentionLimitTimeoutMinutes = 10,
                MentionLimitMessageDeleteDays = 0,
                InviteLinkAction = InfractionAction.Timeout,
                InviteLinkAutoLockdown = false,
                InviteLinkTimeoutMinutes = 10,
                InviteLinkMessageDeleteDays = 0,
                SuspiciousLinkAction = InfractionAction.Timeout,
